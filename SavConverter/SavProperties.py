...
class IntProperty:
    ...
    def __init__(self, name, sav_reader):
        ...
        self.name = name
        self.padding_static=sav_reader.read_bytes(len(IntProperty.padding)//2)
        self.padding=sav_reader.read_bytes(len(IntProperty.padding)//2)
        sav_reader.read_bytes(len(IntProperty.padding)%2)
    ...
    def to_bytes(self):
        return write_string(self.name) + write_string(self.type) + write_bytes(self.padding_static) + write_bytes(self.padding) + write_bytes("00") + write_int32(self.value)
...
class Int8Property:
    padding = bytes([0x01] + [0x00] * 8)
    type = "Int8Property"

    def __init__(self, name, sav_reader):
        self.type = "Int8Property"
        self.name = name
        self.padding_static=sav_reader.read_bytes(len(Int8Property.padding)//2)
        self.padding=sav_reader.read_bytes(len(Int8Property.padding)//2)
        sav_reader.read_bytes(len(Int8Property.padding)%2)
        self.value = sav_reader.read_int8()
    ...
    def to_bytes(self):
        return write_string(self.name) + write_string(self.type) + write_bytes(self.padding_static) + write_bytes(self.padding) + write_bytes("00") + write_int8(self.value)  # Assuming write_int64 writes an int64 to bytes
...
class UInt32Property:
    ...
    def __init__(self, name, sav_reader):
        ...
        self.name = name
        self.padding_static=sav_reader.read_bytes(len(UInt32Property.padding)//2)
        self.padding=sav_reader.read_bytes(len(UInt32Property.padding)//2)
        sav_reader.read_bytes(len(UInt32Property.padding)%2)        
